...
class Eval_thread():
    ...
    def run(self):
        ...
        self.LOG('{} dataset with {} method get {:.4f} mae, {:.4f} max-fmeasure\n'.format(self.dataset, self.method, mae, max_f))
        return '[cost:{:.4f}s]{} dataset with {} method get {:.4f} mae, {:.4f} max-fmeasure'.format(time.time()-start_time, self.dataset, self.method, mae, max_f)
    def Eval_mae(self):
